...
public class Game_lvl1 extends JFrame implements KeyListener, ActionListener,MouseMotionListener{
	/**
	 * 
	 */
	...
	private JLabel lvl=new JLabel("Level :1");
	...
	private	Bricks brick0=new Bricks_lvl1(60, 50);
	private	Bricks brick1=new Bricks_lvl1(60, 80);
	private	Bricks brick2=new Bricks_lvl1(140, 50);
	private	Bricks brick3=new Bricks_lvl1(140, 80);
	private	Bricks brick4=new Bricks_lvl1(220, 50);
	private	Bricks brick5=new Bricks_lvl1(220, 80);
	private	Bricks brick6=new Bricks_lvl1(300, 50);
	private	Bricks brick7=new Bricks_lvl1(300, 80);
	private	Bricks brick8=new Bricks_lvl1(380, 50);
	private	Bricks brick9=new Bricks_lvl1(380, 80);
	private	Bricks brick10=new Bricks_lvl1(460, 50);
	/*private	JLabel brick8=new JLabel("");
	private	JLabel brick9=new JLabel("");
	private	JLabel brick10=new JLabel("");*/
	
	
	private int brick_counter=4;
	Timer timer;
	private int delay=8;
	int lives=3;
	...
	public void paint() {
		...
		//player.setBounds(playerX, playerY, 150, 20);
		//player.setLayout(new FlowLayout());
		//player.add(player_Left);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(play) {
			...
			if(ball.getBounds().intersects(brick0.getBounds()) ) {
				if((ball.getLocation().y<=brick0.getLocation().y+19||ball.getLocation().y+19>=brick0.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				if(ball.getLocation().x+19<=brick0.getLocation().x||ball.getLocation().x>=brick0.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick0.getBackground().equals(Color.YELLOW)) {
						brick0.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick1.getBounds()) ) {
				if((ball.getLocation().y<=brick1.getLocation().y+19||ball.getLocation().y+19>=brick1.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				if(ball.getLocation().x+19<=brick1.getLocation().x||ball.getLocation().x>=brick1.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick1.getBackground().equals(Color.YELLOW)) {
						brick1.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick2.getBounds()) ) {
				if((ball.getLocation().y<=brick2.getLocation().y+19||ball.getLocation().y+19>=brick2.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick2.getLocation().x||ball.getLocation().x>=brick2.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick2.getBackground().equals(Color.YELLOW)) {
						brick2.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick3.getBounds()) ) {
				if((ball.getLocation().y<=brick3.getLocation().y+19||ball.getLocation().y+19>=brick3.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick3.getLocation().x||ball.getLocation().x>=brick3.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick3.getBackground().equals(Color.YELLOW)) {
						brick3.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick4.getBounds()) ) {
				if((ball.getLocation().y<=brick4.getLocation().y+19||ball.getLocation().y+19>=brick4.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick4.getLocation().x||ball.getLocation().x>=brick4.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick4.getBackground().equals(Color.YELLOW)) {
						brick4.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick5.getBounds()) ) {
				if((ball.getLocation().y<=brick5.getLocation().y+19||ball.getLocation().y+19>=brick5.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick5.getLocation().x||ball.getLocation().x>=brick5.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick5.getBackground().equals(Color.YELLOW)) {
						brick5.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick6.getBounds()) ) {
				if((ball.getLocation().y<=brick6.getLocation().y+19||ball.getLocation().y+19>=brick6.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick6.getLocation().x||ball.getLocation().x>=brick6.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick6.getBackground().equals(Color.YELLOW)) {
						brick6.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick7.getBounds()) ) {
				if((ball.getLocation().y<=brick7.getLocation().y+19||ball.getLocation().y+19>=brick7.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick7.getLocation().x||ball.getLocation().x>=brick7.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick7.getBackground().equals(Color.YELLOW)) {
						brick7.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick8.getBounds()) ) {
				if((ball.getLocation().y<=brick8.getLocation().y+19||ball.getLocation().y+19>=brick8.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick8.getLocation().x||ball.getLocation().x>=brick8.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick8.getBackground().equals(Color.YELLOW)) {
						brick8.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick9.getBounds()) ) {
				if((ball.getLocation().y<=brick9.getLocation().y+19||ball.getLocation().y+19>=brick9.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick9.getLocation().x||ball.getLocation().x>=brick9.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick9.getBackground().equals(Color.YELLOW)) {
						brick9.setBackground(Color.RED);
			...
			if(ball.getBounds().intersects(brick10.getBounds()) ) {
				if((ball.getLocation().y<=brick10.getLocation().y+19||ball.getLocation().y+19>=brick10.getLocation().y)) {
					ballYdir= -ballYdir;
				...
				else if(ball.getLocation().x+19<=brick10.getLocation().x||ball.getLocation().x>=brick10.getLocation().x+69) {
					ballxdir= -ballxdir;
					if(brick10.getBackground().equals(Color.YELLOW)) {
						brick10.setBackground(Color.RED);
			...
			if(brick_counter==0) {
				play=false;
				level_score+=(lives*300);
				JOptionPane.showMessageDialog(this,"your score = "+level_score);
				
				
				
				//panel.setVisible(false);
				setVisible(false);
				Game_lvl2 gm2=new Game_lvl2(level_score);
				//setBounds(0,0,600,800);
				//setResizable(false);
