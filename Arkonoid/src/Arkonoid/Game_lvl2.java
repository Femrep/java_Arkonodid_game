...
public class Game_lvl2 extends JFrame implements KeyListener, ActionListener,MouseMotionListener{
	/**
	 * 
	 */
	...
	private JLabel lvl=new JLabel("Level :2");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(play) {
			...
			/*if(ball.getBounds().intersects(brick1.getBounds())&& (ball.getLocation().y<=brick1.getLocation().y+20||ball.getLocation().y+20>=brick1.getLocation().y)) {
				ballYdir= -ballYdir;
			...
			if(ball.getBounds().intersects(brick1.getBounds())&& (ball.getLocation().x+20<=brick1.getLocation().x||ball.getLocation().x>=brick1.getLocation().x+70)) {
				ballxdir= -ballxdir;
				brick1.setVisible(false);
				backGround.remove(brick1);
				brick1.setBounds(0, 0, 0, 0);
			...
			if(ball.getBounds().intersects(brick2.getBounds()) ) {
				if((ball.getLocation().y<=brick2.getLocation().y+20||ball.getLocation().y+20>=brick2.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick2.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick2.getLocation().x||ball.getLocation().x>=brick2.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick3.getBounds()) ) {
				if((ball.getLocation().y<=brick3.getLocation().y+20||ball.getLocation().y+20>=brick3.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick3.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick3.getLocation().x||ball.getLocation().x>=brick3.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick4.getBounds()) ) {
				if((ball.getLocation().y<=brick4.getLocation().y+20||ball.getLocation().y+20>=brick4.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick4.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick4.getLocation().x||ball.getLocation().x>=brick4.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick6.getBounds()) ) {
				if((ball.getLocation().y<=brick6.getLocation().y+20||ball.getLocation().y+20>=brick6.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick6.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick6.getLocation().x||ball.getLocation().x>=brick6.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick7.getBounds()) ) {
				if((ball.getLocation().y<=brick7.getLocation().y+20||ball.getLocation().y+20>=brick7.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick7.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick7.getLocation().x||ball.getLocation().x>=brick7.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick8.getBounds()) ) {
				if((ball.getLocation().y<=brick8.getLocation().y+20||ball.getLocation().y+20>=brick8.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick8.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick8.getLocation().x||ball.getLocation().x>=brick8.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick9.getBounds()) ) {
				if((ball.getLocation().y<=brick9.getLocation().y+20||ball.getLocation().y+20>=brick9.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick9.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick9.getLocation().x||ball.getLocation().x>=brick9.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(ball.getBounds().intersects(brick10.getBounds()) ) {
				if((ball.getLocation().y<=brick10.getLocation().y+20||ball.getLocation().y+20>=brick10.getLocation().y)) {
					ballYdir= -ballYdir;
					if(brick10.getBackground().equals(Color.RED)) {
				...
				if(ball.getLocation().x+20<=brick10.getLocation().x||ball.getLocation().x>=brick10.getLocation().x+70) {
					ballxdir= -ballxdir;
			...
			if(brick_counter==0) {
				...
				setVisible(false);
				dispose();
				Game_lvl3 gm3=new Game_lvl3(level_score);
				setVisible(false);
				gm3.setVisible(true);
